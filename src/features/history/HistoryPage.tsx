...
export function HistoryPage() {
  ...
  return (
    <div className="library-page min-h-screen bg-surface-0 px-4 pb-12 pt-6 md:px-8 md:pb-16 md:pt-8 lg:px-10 lg:pt-10 space-y-8">
      {/* Header */}
      <div>
        ...
        {profileHistory.length > 0 && (
          <button
            ...
            className="mt-4 flex min-h-11 w-full items-center justify-center gap-2 rounded-xl border border-line bg-surface-2 text-sm font-semibold text-white/70 transition-all hover:bg-surface-3 hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent sm:w-auto sm:px-4"
          >
    ...
    <div className="group flex items-center gap-4 p-3 rounded-xl bg-white/3 hover:bg-white/5 border border-white/5 hover:border-white/8 transition-all">
      ...
      <div className="flex shrink-0 items-center gap-2">
        <Link
          ...
          className="flex h-11 w-11 items-center justify-center rounded-xl bg-accent/20 text-accent transition-colors hover:bg-accent/30 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent"
        >
        ...
        <button
          ...
          className="flex h-11 w-11 items-center justify-center rounded-xl bg-white/5 text-white/50 transition-colors hover:bg-white/10 hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent"
        >
          <Trash2 className="h-4 w-4" />
        </button>
      </div>
