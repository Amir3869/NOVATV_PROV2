...
export function CatalogManager({
  ...
  /** Conservé pour l'appelant (titre déjà dans AppDialog). */
  title: string;
  /** Conservé pour l'appelant (texte déjà dans AppDialog). */
  hint: string;
}) {
  ...
  return (
    <>
      <div className="mb-4 flex items-center gap-2 rounded-2xl border border-white/8 bg-white/5 px-4 py-3">
              ...
              <li key={cat.id}>
                ...
                <div className="flex items-center gap-3 py-2.5">
                  ...
                  <button
                    ...
                    className="w-11 h-11 rounded-xl flex items-center justify-center text-white/40 hover:text-white hover:bg-white/10 transition-colors flex-shrink-0"
                  >
                  ...
                  {catRenamed && (
                    <button
                      ...
                      className="w-11 h-11 rounded-xl bg-white/5 hover:bg-white/10 flex items-center justify-center text-white/50 hover:text-white transition-colors flex-shrink-0"
                    >
                            ...
                            <li key={ch.id} className="flex items-center gap-3 py-2">
                              <div className="w-12 h-8 rounded-lg bg-surface-3 flex items-center justify-center flex-shrink-0 overflow-hidden">
                                <ImageWithFallback
                                  ...
                                  fallbackClassName="flex h-8 w-12 items-center justify-center"
                                  fallback={<Tv className="w-4 h-4 text-white/25" />}
                                />
                              </div>
